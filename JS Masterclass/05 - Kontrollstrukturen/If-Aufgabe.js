...
if(students1.length >= students2.length) {
    ...
    console.debug(newStudent, students2)
} else if (students1.length <= students2.length) {
    students1.push(newStudent)
    console.debug(newStudent, students1)
}
console.log("-".repeat(20))
...
let withdrawnStudent = "Laura"

if (students1.indexOf(withdrawnStudent) !== -1) {
    students1.splice(students1.indexOf(withdrawnStudent), 1)
    console.log(students1, withdrawnStudent + " wurde entfernt.")
} else if (students2.indexOf(withdrawnStudent) !== -1) {
    students2.splice(students2.indexOf(withdrawnStudent), 1)
    console.log(students2, withdrawnStudent + " wurde entfernt.")
} else {
    console.error(withdrawnStudent + " nimmt an keinem Sprachkurs teil.")
}

console.debug("students1", students1)
console.debug("students2", students2)
console.log("-".repeat(20))

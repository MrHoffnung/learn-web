...
studentsList.splice(studentsList.indexOf("Erika"), 1)
...
studentsList[0] = "- " + studentsList[0]
let print = studentsList.join("\n- ")
console.log(print)
...
let sentenceWords = sentence.split(" ").length
console.log("Wörter im Satz", sentenceWords)
